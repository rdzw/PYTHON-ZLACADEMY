...
numero_funcionario = int(input("Digite seu numero: "))
qtd_horas_trabalhada = int(input("Quantidade horas: "))
valor_hora = float(input("valor hora: "))

calculo = qtd_horas_trabalhada * valor_hora
# Saída
